...
pub struct LazyDecodedObject<R: BufRead> {
    pub file_path: String,
    pub object_type: ObjectType,
    pub size: u64,
    reader: R,
}
impl<R: BufRead> LazyDecodedObject<R> {
...
pub fn find_and_decode_object(object: String) -> anyhow::Result<LazyDecodedObject<impl BufRead>> {
...
pub fn find_object_file(object: String) -> anyhow::Result<String> {
    let len = object.len();
    if (len < 4) || (len > 40) {
...
pub fn is_end_of_reader(mut reader: impl BufRead) -> bool {
